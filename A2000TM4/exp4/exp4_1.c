...
uint8_t lcd_act = 0; // LCD屏幕状态机当前状态
    ...
    while (1)
    {
        ...
        if (clock2s_flag)
        {
            ...
            case 4:
                ...
                display_string_5x8(3, 1, "<!@#$%^&*()_-+]/;.,?[", true); //在第 3 页，第 1 列，显示一串 5x8 点阵的 ASCII 字
                display_string_5x8(4, 1, "JLX electronics Co., ", false); //显示一串 5x8 点阵的 ASCII 字
                display_string_5x8(5, 1, "Ltd. established at ", true);  //显示一串 5x8 点阵的 ASCII 字
                display_string_5x8(6, 1, "year 2004.Focus LCM. ", false); //显示一串 5x8 点阵的 ASCII 字
                display_string_5x8(7, 1, "TEL:0755-29784961 ", true);    //显示一串 5x8 点阵的 ASCII 字
                display_string_5x8(8, 1, "FAX:0755-29784964 ", false);    //显示一串 5x8 点阵的 ASCII 字
                break;
            case 5:
                ++lcd_act;
                display_GB2312_string(1, 1, "啊阿埃挨哎唉哀皑", true); //在第 1 页，第 1 列，显示一串 16x16 点阵汉字或 8x16 的 ASCII 字
                display_GB2312_string(3, 1, "癌蔼矮艾碍爱隘鞍", false); //显示一串 16x16 点阵汉字或 8x16 的ASCII 字.以下雷同
                display_GB2312_string(5, 1, "氨安俺按暗岸胺案", true);
                display_GB2312_string(7, 1, "肮昂盎凹敖熬翱袄", false);
                break;
            case 6:
                lcd_act = 0;
                display_GB2312_string(1, 1, "鬟鬣麽麾縻麂麇麈", false);
                display_GB2312_string(3, 1, "麋麒鏖麝麟黛黜黝", true);
                display_GB2312_string(5, 1, "黠黟黢黩黧黥黪黯", false);
                display_GB2312_string(7, 1, "鼢鼬鼯鼹鼷鼽鼾齄", true);
                break;
            default:
                break;
            }
